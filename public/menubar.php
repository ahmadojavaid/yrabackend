        ...
        <nav class="cyan">
            <div class="nav-wrapper">
                <h1 class="logo-wrapper"><a href="dashboard.php" class="brand-logo darken-1"><img
                        ...
                        class="logo-text">Your Restaurant App</span></h1>
            ...
            <ul id="slide-out" class="side-nav fixed leftside-navigation">
                ...
                <li class="bold">
                    <a href="reservation.php" class="waves-effect waves-cyan">
                        <i class="mdi-action-shopping-cart"></i>Reservation
                    </a>
                </li>
                ...
                <li class="bold">
                    <a href="menu.php" class="waves-effect waves-cyan">
                        <i class="mdi-action-store"></i>Restaurant Menu
                    </a>
                </li>
                ...
                <li class="bold">
                    <a href="admin.php" class="waves-effect waves-cyan">
                        <i class="mdi-action-settings"></i>Setting
                    </a>
                </li>                                
